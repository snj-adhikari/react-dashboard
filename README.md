...
Paper Dashboard React is built using the same design language as [Paper Dashboard 2](https://beamafilm.com/product/paper-dashboard-2).
...
[<img src="https://s3.amazonaws.com/creativetim_bucket/github/html.png" width="60" height="60" />](https://beamafilm.com/product/paper-dashboard-2)
[<img src="https://s3.amazonaws.com/creativetim_bucket/github/react.svg" width="60" height="60" />](https://beamafilm.com/product/paper-dashboard-react)


| HTML | React |
| --- | --- |
| [![Paper Dashboard 2 HTML](https://s3.amazonaws.com/creativetim_bucket/products/86/thumb/opt_pd2_thumbnail.jpg)](https://beamafilm.com/product/paper-dashboard-2) | [![Paper Dashboard React](https://s3.amazonaws.com/creativetim_bucket/products/98/thumb/opt_pd_react_thumbnail.jpg)](https://beamafilm.com/product/paper-dashboard-react) |
...
- `npm install`
- `npm start`
- Visit the url : `localhost:3000/admin/dashboard` 
...
- Download Page: https://beamafilm.com/product/paper-dashboard-react
- Documentation: https://demos.creative-tim.com/paper-dashboard-react/#/documentation/tutorial
- License Agreement: https://beamafilm.com/license
- Support: https://beamafilm.com/contact-us
...
1. Make sure that you are using the latest version of the Paper Dashboard React. Check the CHANGELOG from your dashboard on our [website](https://beamafilm.com/).
2. Providing us reproducible steps for the issue will shorten the time it takes for it to be fixed.
3. Some issues may be browser specific, so specifying in what browser you encountered the issue might help.

## Technical Support or Questions

If you have questions or need help integrating the product please [contact us](https://beamafilm.com/contact-us) instead of opening an issue.

## Licensing

- Copyright 2020 Beamafilm (https://beamafilm.com)
